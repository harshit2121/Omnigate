...
import { Search, Edit, Eye, Pill, Plus } from 'lucide-react';
...
export default function PatientList({ patients, medications }) {
  ...
  const [addMedPatient, setAddMedPatient] = useState(null);
  ...
  const handleAddMedication = (patient) => {
    setAddMedPatient(patient);
                      ...
                      <TableCell>
                        <div className="flex gap-2 justify-end">
                          ...
                          <Button 
                            ...
                            className="hover:bg-green-50 text-green-600 border-green-300"
                          >
          ...
          <DialogContent className="max-w-4xl max-h-[90vh] overflow-y-auto">
            <DialogHeader>
              <div className="flex items-center justify-between">
                ...
                <Button
                  size="sm"
                  onClick={() => handleAddMedication(viewPatient)}
            ...
            <div className="space-y-6">
              ...
              <div>
                <h3 className="text-lg font-bold mb-3 flex items-center gap-2">
                  <Pill size={20} />
                  Current Medications ({getPatientMeds(viewPatient.hhid).length})
                </h3>
                {getPatientMeds(viewPatient.hhid).length === 0 ? (
                  <div className="text-center py-8 border-2 border-dashed rounded-lg">
                    <Pill size={48} className="mx-auto text-slate-300 mb-2" />
                    <p className="text-slate-500 mb-3">No medications prescribed yet</p>
                    <Button
                      size="sm"
                      onClick={() => handleAddMedication(viewPatient)}
